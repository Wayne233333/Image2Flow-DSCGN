...
parser.add_argument('--log', type=str, default='log/OD_LA.log') # 'log/default.log'
parser.add_argument('--node_feats_path', type=str, default='../data/Vis/train_on_LA_2020.csv') 
parser.add_argument('--region', type=str, default='LA') 
...
def train(train_args, logger):
    ...
    # sampler = dgl.dataloading.MultiLayerNeighborSampler([200] * (train_args.num_hidden_layers + 1)) #others
    # sampler = dgl.dataloading.MultiLayerNeighborSampler([50, 40, 30]) #NY
